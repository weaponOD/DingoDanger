...
Shader "Shader Forge/UpShader" {
    Properties {
        ...
        _GradientColourIntensity ("GradientColourIntensity", Range(0, 1)) = 0.5
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float node_2438 = (_Low*2.0+-1.0);
                float node_1270 = 0.0;
                float3 node_3159 = (_GradientColour.rgb*(_GradientColourIntensity*3.0+0.0)*saturate((node_1270 + ( (((i.posWorld.g-objPos.g)*_Opacity) - node_2438) * (1.0 - node_1270) ) / ((_High*2.0+-1.0) - node_2438))));
                float3 node_1833 = lerp(_BaseColour.rgb,node_3159,0.5);
